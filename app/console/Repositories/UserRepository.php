    ...
    */
    public function createTeacher($request) {
        try {
            ...
            throw new \Exception('Algo ha fallado al tratar de guardar los datos. '.$e->getMessage());
        }
    }
    ...
    */
    public function createStudent($request) {
        try {
            ...
            throw new \Exception('lgo fallo al crear los datos del estudiante. '.$e->getMessage());
        }
    }
    ...
    public function updateStudent($request) {
        try {
            ...
            throw new \Exception('Algo falló al tratar de actualizar la información. '.$e->getMessage());
        }
    }
    ...
    public function updateTeacher($request) {
        try {
            ...
            throw new \Exception('Algo falló al intentar aplicar la actualización. '.$e->getMessage());
        }
    }
